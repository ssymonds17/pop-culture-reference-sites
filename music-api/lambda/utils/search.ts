 ...
 * letter plus a separate combining mark, then strips those marks. So "Bjork",
 * "Björk" and "BJÖRK" all fold to "bjork" and match each other, regardless of
 * accents on the stored value or the query.
 *
